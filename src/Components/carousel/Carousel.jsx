...
const Carousel = () => {
  ...
  const images = [
    ...
    {
      src: "https://a.eu.mktgcdn.com/f/100004519/koi_zfWiausOCLtK8hVQu4vJKKykfdrzlYUUZvqjG08.jpg",
      alt: "Flight 3",
      caption: "Aircraft landing at sunset",
    },
    {
      src: "https://www.construction21.org/france/data/sources/users/19568/20231221133829-depositphotos660854136xl-1.webp",
      alt: "Flight 3",
      caption: "Aircraft landing at sunset",
    },
    {
      src: "https://media.tacdn.com/media/attractions-content--1x-1/0b/e2/03/6d.jpg",
      alt: "Flight 3",
      caption: "Aircraft landing at sunset",
    },
  ];
          ...
          {images.map((_, index) => (
            <button
              ...
              className={`${styles.dot} ${
                currentIndex === index ? styles["active-dot"] : ""
              }`}
